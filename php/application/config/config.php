...
$config['facebook_app_id'] 		= '508035539210735'; 
$config['facebook_app_secret'] 	= '7100963b64b645d82aea6108aeab68c2'; 
$config['carbon_email'] 		= 'owen@click3x.com';
$config['app_short_url']		= "http://on.fb.me/SQn7Zm";
$config['GOOGLE_ANALYTICS_ID']	= 'UA-34356376-1';
$config['twitter_hashtag']		= 'UltimateTailgate';
$config['default_video']		= "bTP1jvJWxjA";
