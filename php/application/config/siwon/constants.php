...
define('INSTALLED_PAGE_URL',					'http://www.facebook.com/Click3xDev/app_408546595850506'); // This is a fallback value. The installed page url will be set by the facebook signed request when available.
