...
<body class="<?=$this->uri->segment(1);?>">
	<div id="header-container">
		<header class="wrapper">
			<img id="title" src="<?= base_url() ?>images/admin/logo.jpg" alt="Admin" />
			<nav>
				<ul>
					<? if( $this->session->userdata('userEmail') ): ?>
						<li><a href="<?= base_url() ?>photo" class="photo">Photo</a></li>
						<li><a href="<?= base_url() ?>email/entries" class="email">Email</a></li>
						<li><a href="<?= base_url() ?>users" class="users">Users</a></li>
						<li><a href="<?= base_url() ?>admin/winners" class="users">Winners</a></li>
